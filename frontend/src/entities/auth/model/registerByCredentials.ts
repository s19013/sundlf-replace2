...
import type { RegisterCredentials } from '@/entities/auth/types/auth'
...
export async function registerByCredentials(credentials: RegisterCredentials): Promise<Result> {
